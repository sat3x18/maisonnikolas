        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              {state.items.map((item, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-xl">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <button
                            ...
                            className="bg-gray-700 text-white w-10 h-10 rounded-lg hover:bg-gray-600 transition-colors duration-300 flex items-center justify-center"
                          >
                        ...
                        <div className="text-right">
                          <div className="flex items-center space-x-2">
                            {item.product.discount_price ? (
                              <>
                                <span className="text-2xl font-bold text-rolex-gold">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-xl sticky top-8">
              ...
              <Link
                to="/checkout"
                className="w-full bg-gradient-to-r from-rolex-green to-rolex-green-dark text-white font-bold py-4 px-6 rounded-lg hover:from-rolex-green-dark hover:to-rolex-green transition-all duration-300 text-center block mb-4"
              >
                Proceed to Checkout
              </Link>
              ...
              <Link
                to="/"
                className="w-full bg-gray-700 text-white font-medium py-3 px-6 rounded-lg hover:bg-gray-600 transition-all duration-300 text-center block"
              >
                Continue Shopping
              </Link>
