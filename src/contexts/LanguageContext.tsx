...
const translations = {
  ka: {
    ...
    // Admin
    'admin.portal': 'ადმინისტრაციული პორტალი',
    'admin.username': 'მომხმარებლის სახელი',
    'admin.password': 'პაროლი',
    'admin.enter_username': 'შეიყვანეთ მომხმარებლის სახელი',
    'admin.enter_password': 'შეიყვანეთ პაროლი',
    'admin.sign_in': 'შესვლა',
    'admin.signing_in': 'შესვლა...',
    'admin.invalid_credentials': 'არასწორი მონაცემები',
    'admin.login_failed': 'შესვლა ვერ მოხერხდა. სცადეთ ხელახლა.',
    'admin.dashboard': 'ადმინისტრაციული პანელი',
    'admin.logout': 'გასვლა',
    'admin.total_orders': 'სულ შეკვეთები',
    'admin.products': 'პროდუქტები',
    'admin.revenue': 'შემოსავალი',
    'admin.pending_orders': 'მოლოდინში მყოფი შეკვეთები',
    'admin.orders': 'შეკვეთები',
    'admin.categories': 'კატეგორიები',
    'admin.search': 'ძიება',
    'admin.add_product': 'პროდუქტის დამატება',
    'admin.add_category': 'კატეგორიის დამატება',
    'admin.edit_product': 'პროდუქტის რედაქტირება',
    'admin.edit_category': 'კატეგორიის რედაქტირება',
    'admin.customer_information': 'მომხმარებლის ინფორმაცია',
    'admin.order_details': 'შეკვეთის დეტალები',
    'admin.payment': 'გადახდა',
    'admin.items': 'ნივთები',
    'admin.update_status': 'სტატუსის განახლება',
    'admin.pending': 'მოლოდინში',
    'admin.confirmed': 'დადასტურებული',
    'admin.shipped': 'გაგზავნილი',
    'admin.completed': 'დასრულებული',
    'admin.cancelled': 'გაუქმებული',
    'admin.current': 'მიმდინარე',
    'admin.no_orders_found': 'შეკვეთები ვერ მოიძებნა',
    'admin.no_orders_match': 'არცერთი შეკვეთა არ შეესაბამება ძიების კრიტერიუმს.',
    'admin.no_products_found': 'პროდუქტები ვერ მოიძებნა',
    'admin.no_products_match': 'არცერთი პროდუქტი არ შეესაბამება ძიების კრიტერიუმს.',
    'admin.no_categories_found': 'კატეგორიები ვერ მოიძებნა',
    'admin.no_categories_available': 'კატეგორიები არ არის ხელმისაწვდომი.',
    'admin.name': 'სახელი',
    'admin.category': 'კატეგორია',
    'admin.description': 'აღწერა',
    'admin.price': 'ფასი',
    'admin.discount_price': 'ფასდაკლებული ფასი',
    'admin.stock': 'მარაგი',
    'admin.images': 'სურათები',
    'admin.colors': 'ფერები',
    'admin.sizes': 'ზომები',
    'admin.featured': 'რჩეული',
    'admin.new': 'ახალი',
    'admin.limited': 'შეზღუდული',
    'admin.select_category': 'აირჩიეთ კატეგორია',
    'admin.image_url': 'სურათის URL',
    'admin.color_name': 'ფერის სახელი',
    'admin.size': 'ზომა',
    'admin.add_image': '+ სურათის დამატება',
    'admin.add_color': '+ ფერის დამატება',
    'admin.add_size': '+ ზომის დამატება',
    'admin.cancel': 'გაუქმება',
    'admin.create_product': 'პროდუქტის შექმნა',
    'admin.update_product': 'პროდუქტის განახლება',
    'admin.slug': 'სლაგი',
    'admin.gender': 'სქესი',
    'admin.select_gender': 'აირჩიეთ სქესი',
    'admin.men': 'მამაკაცები',
    'admin.women': 'ქალები',
    'admin.create_category': 'კატეგორიის შექმნა',
    'admin.update_category': 'კატეგორიის განახლება',
    'admin.unisex': 'უნისექსი',
    'admin.loading_dashboard': 'პანელის ჩატვირთვა...',
    // Newsletter
    ...
    'product.not_found': 'პროდუქტი ვერ მოიძებნა',
    'product.not_found_desc': 'პროდუქტი, რომელსაც ეძებთ, არ არსებობს.',
    'product.back_to_home': 'მთავარ გვერდზე დაბრუნება',
    'product.loading': 'პროდუქტის დეტალების ჩატვირთვა...',
    ...
    'category.loading_collection': 'კოლექციის ჩატვირთვა...',
    ...
    'sale.loading_items': 'ფასდაკლებული ნივთების ჩატვირთვა...',
    'sale.shop_now': 'იყიდე ახლა',
    ...
    'common.continue_shopping': 'შოპინგის გაგრძელება',

    // Product categories
    'categories.shirts': 'პერანგები',
    'categories.suits': 'კოსტუმები', 
    'categories.casual': 'კაზუალური ტანსაცმელი',
    'categories.dresses': 'კაბები',
    'categories.blouses': 'ბლუზები',
    'categories.skirts': 'ქვედაბოლოები',
    'categories.premium_shirts': 'პრემიუმ პერანგები',
    'categories.tailored_suits': 'მორგებული კოსტუმები',
    'categories.elegant_dresses': 'ელეგანტური კაბები',
    'categories.designer_blouses': 'დიზაინერული ბლუზები',
    'categories.premium_skirts': 'პრემიუმ ქვედაბოლოები',
    'categories.casual_wear': 'კაზუალური ტანსაცმელი',
    ...
    'order.loading': 'შეკვეთის დეტალების ჩატვირთვა...',
    'order.details': 'შეკვეთის დეტალები',

    // Review
    'review.leave_review': 'მიმოხილვის დატოვება',
    'review.share_experience': 'გაუზიარეთ თქვენი გამოცდილება შეძენილ პროდუქტებზე',
    'review.thank_you': 'გმადლობთ!',
    'review.all_submitted': 'ყველა მიმოხილვა წარმატებით გაიგზავნა.',
    'review.your_name': 'თქვენი სახელი',
    'review.enter_name': 'შეიყვანეთ თქვენი სახელი',
    'review.rating': 'შეფასება',
    'review.click_to_rate': 'დააჭირეთ შესაფასებლად',
    'review.stars': 'ვარსკვლავი',
    'review.star': 'ვარსკვლავი',
    'review.your_review': 'თქვენი მიმოხილვა (არასავალდებულო)',
    'review.share_thoughts': 'გაუზიარეთ თქვენი აზრი ამ პროდუქტზე...',
    'review.submit': 'მიმოხილვის გაგზავნა',
    'review.submitting': 'იგზავნება...',
    'review.cancel': 'გაუქმება',
    'review.write_review': 'მიმოხილვის დაწერა',
    'review.submitted': 'მიმოხილვა გაიგზავნა',
    'review.skip': 'მიმოხილვების გამოტოვება და შოპინგის გაგრძელება',
    'review.not_ready': 'შეკვეთა მიმოხილვისთვის მზად არ არის',
    'review.completed_only': 'მხოლოდ დასრულებული შეკვეთების მიმოხილვა შეგიძლიათ.',
  },
  en: {
    // Header
    'header.men': 'MEN',
